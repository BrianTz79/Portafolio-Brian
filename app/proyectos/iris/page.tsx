  ...
  return (
    <div className="container mx-auto px-4 py-16 md:py-24 flex flex-col items-start min-h-screen max-w-5xl">
      ...
      <div className="flex flex-col md:flex-row md:items-center gap-6 mb-12 border-b border-border/50 pb-12 w-full">
         <div className="h-20 w-20 rounded-2xl bg-purple-500/10 flex items-center justify-center text-purple-500 border border-purple-500/20 shrink-0">
         ...
         <div className="flex flex-col">
            ...
            <span className="inline-block px-3 py-1 bg-purple-500/10 text-purple-400 border border-purple-500/20 rounded-full text-sm font-semibold w-fit">
               {data.status}
            </span>
         </div>
      </div>
