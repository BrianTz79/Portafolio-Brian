            ...
            <section>
               ...
               <div className="grid gap-6">
                  {data.architecture_items.map((item: any, idx: number) => (
                     <div key={idx} className="p-6 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl border-l-[3px] border-l-emerald-400 dark:border-l-emerald-500/50 shadow-sm dark:shadow-none">
