...
import { ArrowLeft, Gamepad2, Layers, CloudCog } from "lucide-react";
  ...
  return (
    <div className="container mx-auto px-4 py-16 md:py-24 flex flex-col items-start min-h-screen max-w-5xl">
      ...
      <div className="flex flex-col md:flex-row md:items-center gap-6 mb-12 border-b border-border/50 pb-12 w-full">
         <div className="h-20 w-20 rounded-2xl bg-emerald-500/10 flex items-center justify-center text-emerald-500 border border-emerald-500/20 shrink-0">
         ...
         <div className="flex flex-col">
            ...
            <span className="inline-block px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 rounded-full text-sm font-semibold w-fit">
               {data.status}
            </span>
         </div>
      </div>
         ...
         <div className="md:col-span-2 space-y-12">
            ...
            <section>
               <h2 className="text-2xl font-bold flex items-center gap-2 mb-6">
                  <CloudCog className="text-emerald-400" />
                  {data.architecture_title}
               </h2>
               <div className="grid gap-6">
                  {data.architecture_items.map((item, idx) => (
                     <div key={idx} className="p-6 bg-card border border-border/50 rounded-xl border-l-[3px] border-l-emerald-500/50">
